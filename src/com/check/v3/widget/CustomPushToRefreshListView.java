...
public class CustomPushToRefreshListView extends ListView implements OnScrollListener {
	...
	public CustomPushToRefreshListView(Context pContext) {
		super(pContext);
		init(pContext);
	}
	
	public CustomPushToRefreshListView(Context pContext, AttributeSet pAttrs) {
		super(pContext, pAttrs);
		init(pContext);
	}

	public CustomPushToRefreshListView(Context pContext, AttributeSet pAttrs, int pDefStyle) {
