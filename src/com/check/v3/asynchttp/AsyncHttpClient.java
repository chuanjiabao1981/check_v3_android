...
import com.check.v3.asynchttp.RequestParams.FileWrapper;
import com.check.v3.asynchttp.RequestParams.StreamWrapper;
...
/**
 * Andy added to send json type post req
 */
	public RequestHandle post(String url, Header[] headers,
			String postBodyStr, String contentType,
			ResponseHandlerInterface responseHandler) {
		return post(null, url, headers, postBodyStr, contentType, responseHandler);
	}
	...
	public RequestHandle post(Context context, String url, Header[] headers,
		...
		try {
			if(postBodyStr != null){
				entity = new ByteArrayEntity(postBodyStr.getBytes(DEFAULT_PROTOCOL_CHARSET));
			}
