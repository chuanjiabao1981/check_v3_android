...
import com.check.v3.ui.adapter.IssueLevelSimpleAdapter;
import com.check.v3.ui.adapter.OrganizationAdapter;
import com.check.v3.ui.adapter.PersonSimpleAdapter;
import com.check.v3.ui.adapter.PhotoGridViewSimpleAdapter;
import com.check.v3.ui.dialog.ConfirmationDialogFragment;
import com.check.v3.ui.dialog.DatePickerDialogFragment;
import com.check.v3.ui.dialog.ListItemDialogFragment;
import com.check.v3.ui.dialog.ProgressDialogFragment;
...
public class QuickCheckEditorFragment extends SherlockFragment implements
	...
	private int mActionMode = Constants.QUICK_CHECK_EDIT_NEW_ACTION;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (args != null) {
			...
			if (mActionMode == Constants.QUICK_CHECK_EDIT_EXIST_ACTION) {
	...
	public void doCommitQuickCheck() {
		...
		for (int i = 0; i < mPhotoListToAdd.size(); i++) {
			FilePartData fileDataItem = new FilePartData(
					Constants.QUICK_REPORT_FILE_PART_KEY,
		...
		String relativeUrl = "";
		if (mActionMode == Constants.QUICK_CHECK_EDIT_NEW_ACTION) {
			relativeUrl = "organizations/" + AccountMngr.getGlobalOrgId()
					+ "/quick_reports";
		} else if (mActionMode == Constants.QUICK_CHECK_EDIT_EXIST_ACTION && mOrigReportId > 0) {
		...
		AsyncHttpResponseHandler responseHandler = new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers,
				...
				origData.putSerializable(Constants.KEY_QUICK_CHECK_DATA, qcRspData);
		...
		JsonParamsPart jsonPart = new JsonParamsPart(
				Constants.QUICK_REPORT_JSON_PART_KEY,
